...
typedef std::function<bool(Print*, size_t, bool, void*)> AwsChunkedStreamFiller;
...
class AsyncWebServerRequest {
  ...
  public:
    ...
    AsyncWebServerResponse *beginChunkedStreamResponse(const String& contentType, AwsChunkedStreamFiller callback, void * callbackArg, size_t bufferSize=0, AwsTemplateProcessor templateCallback=nullptr);
    AsyncWebServerResponse *beginStreamRepeaterResponse(const String& contentType, AwsChunkedStreamFiller callback, void * callbackArg, size_t bufferSize=0, AwsTemplateProcessor templateCallback=nullptr);
